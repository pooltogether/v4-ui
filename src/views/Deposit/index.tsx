...
import { CHAIN_ID, RPC_API_KEYS, useWalletSigner } from '@pooltogether/wallet-connection'
import { Contract } from 'ethers'
import { parseEther, parseUnits } from 'ethers/lib/utils'

const address = '0x2A94Ae8A4F08B7FD068D7A52032244F93f272317'
const abi = [
  {
    inputs: [
...
// const provider = getReadProvider(CHAIN_ID.mumbai, RPC_API_KEYS)
...
export const DepositUI = () => {
  ...
  return (
    <PagePadding className='flex flex-col space-y-6'>
      <button
        onClick={() =>
          contract.mint('0x27fcf06DcFFdDB6Ec5F62D466987e863ec6aE6A0', parseEther('1000000000000'))
        }
      >
        MINT TOKENS
      </button>
