...
import { useDrawBeaconPeriod } from '@src/hooks/v4/PrizePoolNetwork/useDrawBeaconPeriod'
...
import { calculateTotalNumberOfPrizes } from '@src/utils/calculateTotalNumberOfPrizes'
