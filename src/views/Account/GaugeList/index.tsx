...
import { useSelectedGaugeController } from '@hooks/v4/Gauge/useSelectedGaugeController'
import { ExplorePoolGaugesModal } from '../ExplorePoolGaugesModal'
import { GaugeStakeSheet, StakeUI } from '@views/Stake'

export const GaugeList = () => {
  const { t } = useTranslation()
  const usersAddress = useUsersAddress()
  const { data: gaugeController, isFetched } = useSelectedGaugeController()
  ...
  return (
    <div id='deposits'>
      <CardTitle className='mb-2' title={'POOL Gauges'} />
      {/* <DepositsList /> */}
      <StakeUI />
      {/* <ExplorePoolGaugesModal
        isOpen={isExploreModalOpen}
        closeModal={() => setIsExploreModalOpen(false)}
      />
      <GaugeStakeSheet
...
//           <DepositItem
//             key={'gauge-balance-' + balances.prizePool.id()}
//             {...balances}
