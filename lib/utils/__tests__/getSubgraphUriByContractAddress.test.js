...
describe('getSubgraphUriByContractAddress', () => {
  describe('rinkeby', () => {
    ...
    xit('is subgraph URI for the cDai pool with staging subgraph', () => {
      ...
      expect(getSubgraphUriByContractAddress(chainId, contractAddress)).toEqual(
        'https://api.thegraph.com/subgraphs/name/pooltogether/rinkeby-staging-v3_0_1'
      )
    })
    ...
    xit('is subgraph URI for the cDai pool', () => {
      ...
      expect(getSubgraphUriByContractAddress(chainId, contractAddress, 'production')).toEqual(
        'https://api.thegraph.com/subgraphs/name/pooltogether/rinkeby-v3_0_1'
      )
    })
    ...
    xit('is subgraph URI cDai strategy with staging subgraph', () => {
      ...
      expect(getSubgraphUriByContractAddress(chainId, contractAddress)).toEqual(
        'https://api.thegraph.com/subgraphs/name/pooltogether/rinkeby-staging-v3_1_0'
      )
    })
