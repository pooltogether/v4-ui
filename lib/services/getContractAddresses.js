...
export const getContractAddresses = (chainId) => {
  let daiPoolAddress, batPoolAddress, uniPoolAddress, usdcPoolAddress, lootBox, lootBoxController
  ...
  const pools = [daiPoolAddress, batPoolAddress, uniPoolAddress, usdcPoolAddress].filter(
    (pool) => pool !== undefined
  )
